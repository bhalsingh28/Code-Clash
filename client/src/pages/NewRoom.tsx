...
//   return (
//     <div className="h-screen overflow-hidden bg-primary-black text-white">
//       <Navbar />
...
//               {/* JOIN ROOM */}
//               <div className="border border-gray-600 rounded-xl flex flex-1 flex-col min-w-0">
...
//                     className="border border-gray-700 flex-1 min-w-0 rounded-lg p-2 bg-transparent"
//                   />

//                   <button
//                     className="bg-blue-700 text-white font-bold px-4 py-2 rounded-lg whitespace-nowrap"
...
//                   <button
//                     className="bg-[#DF301C] text-white flex-1 font-bold px-4 py-2 rounded-lg"
